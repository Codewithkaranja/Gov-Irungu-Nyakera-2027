        ...
        let additionalNews = [
            {
                category: "events",
                date: "May 25, 2025",
                title: "Women's Empowerment Forum Draws Hundreds in Eastlands",
                excerpt: "Irungu Nyakera hosted a women's empowerment forum focusing on economic opportunities, safety, and political participation for Nairobi women.",
            ...
            },
            {
                category: "policy",
                date: "May 22, 2025",
                title: "Environmental Policy: Nyakera Pledges to Increase Nairobi's Green Spaces by 30%",
                excerpt: "Detailed plan unveiled to combat climate change in Nairobi through increased tree planting, waste management reforms, and green building incentives.",
            ...
            },
            {
                category: "media",
                date: "May 18, 2025",
                title: "Interview with Business Daily: Nyakera Outlines Economic Recovery Plan",
                excerpt: "In a detailed interview, Irungu Nyakera discusses how he plans to revive Nairobi's economy post-pandemic through strategic investments and business support.",
        ...
        document.querySelector('a[href="#donate"]').addEventListener('click', function(e) {
            ...
            modal.innerHTML = `
                <div style="background: white; padding: 40px; border-radius: 10px; max-width: 500px; width: 90%; position: relative;">
                    ...
                    <p style="color: var(--gray); margin-bottom: 20px;">Your donation helps us reach more voters and build a better Nairobi. Choose your donation method:</p>
                    ...
                    <div style="margin-bottom: 25px;">
                        ...
                        <div style="background: #f3f4f6; padding: 15px; border-radius: 5px; margin-bottom: 15px;">
                            ...
                            <p style="margin-bottom: 10px;"><strong>Account Number:</strong> IRUNGUNYAKERA</p>
                        </div>
                    </div>
                    ...
                    <div style="margin-bottom: 30px;">
                        ...
                        <div style="background: #f3f4f6; padding: 15px; border-radius: 5px;">
                            ...
                            <p style="margin-bottom: 10px;"><strong>Account Name:</strong> Irungu Nyakera Campaign</p>
                            <p style="margin-bottom: 10px;"><strong>Account Number:</strong> 0123456789</p>
                            <p><strong>Branch:</strong> Nairobi Central</p>
                        </div>
                    </div>
