        ...
        volunteerForm.addEventListener('submit', function(e) {
            ...
            volunteerFormMessage.innerHTML = `
                <div style="background-color: #d1fae5; color: #065f46; padding: 15px; border-radius: 5px; border-left: 4px solid var(--emerald);">
                    ...
                    <p style="margin-top: 10px; font-size: 0.9rem;">For urgent inquiries, please call us at <a href="tel:+254727329860" style="color: #065f46; font-weight: bold;">+254 727 329 860</a>.</p>
                </div>
            `;
